...
#########################
#########################
parser = argparse.ArgumentParser(description="Fit a RealNVP normalizing flow with argmaxed label indices to a GMM with Palmer penguins data set")
...
########################
########################
print('Training a RealNVP normalizing flow with argmaxed label indices for a GMM with the Palmer penguin data set')
print()
