...
#########################
#########################
parser = argparse.ArgumentParser(description="Fit a RealNVP normalizing flow with dequantized label indices to a GMM with Palmer penguins data set")
...
########################
########################
print('Training a RealNVP normalizing flow with dequantized label indices for a GMM with the Palmer penguin data set')
print()
