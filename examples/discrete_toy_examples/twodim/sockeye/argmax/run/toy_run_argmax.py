...
#########################
#########################
parser = argparse.ArgumentParser(description="Fit a RealNVP normalizing flow with argmaxed nodes")

parser.add_argument('--target', type = str, default = 'onedim', choices=['onedim', 'twodim', 'threedim'],
...
########################
########################
print('Training a RealNVP normalizing flow with argmaxed discrete nodes')
print()
