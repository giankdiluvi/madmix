...
#########################
#########################
parser = argparse.ArgumentParser(description="Fit a RealNVP normalizing flow with dequantized label indices to a Soike and Slab model with superconductivity data")
...
########################
########################
print('Training a RealNVP normalizing flow with dequantized label indices for a Spike and Slab model with the superconductivity data set')
print()
