...
#########################
#########################
parser = argparse.ArgumentParser(description="Fit a RealNVP normalizing flow with argmaxed label indices to a Spike and Slab model with prostate cancer data")
...
########################
########################
print('Training a RealNVP normalizing flow with argmaxed label indices for a Spike and Slab model with the prostate cancer data set')
print()
