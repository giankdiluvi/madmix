...
#########################
#########################
parser = argparse.ArgumentParser(description="Fit a RealNVP normalizing flow with relaxed label indices to a Spike and Slab model with prostate cancer data")
...
########################
########################
print('Training a RealNVP normalizing flow with relaxed label indices for a Spike and Slab model with the prostate cancer data set')
print()
